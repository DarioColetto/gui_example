from tkinter import Button, Checkbutton, Frame, IntVar, LabelFrame, Listbox, Radiobutton, ttk
...
class Some_Widgets(GUI):  
    def __init__(self, parent, controller):
        ...
        frame1 = LabelFrame(self, frame_styles, text="This is a LabelFrame containing a Treeview")
        frame1.place(rely=0.05, relx=0.02, height=400, width=400)

        frame2 = LabelFrame(self, frame_styles, text="Some widgets")
        frame2.place(rely=0.05, relx=0.45, height=500, width=500)

        button1 = Button(frame2, text="tk button", command=lambda: Refresh_data())
        button1.pack()
        ...
        Var1 = IntVar()
        Var2 = IntVar()
        Cbutton1 = Checkbutton(frame2, text="tk CheckButton1", variable=Var1, onvalue=1, offvalue=0)
        Cbutton1.pack()
        Cbutton2 = Checkbutton(frame2, text="tk CheckButton2", variable=Var2, onvalue=1, offvalue=0)
        Cbutton2.pack()
        ...
        Lbox1 = Listbox(frame2, selectmode="multiple")
        ...
        Var3 = IntVar()
        R1 = Radiobutton(frame2, text="tk Radiobutton1", variable=Var3, value=1)
        R1.pack()
        R2 = Radiobutton(frame2, text="tk Radiobutton2", variable=Var3, value=2)
        R2.pack()
        R3 = Radiobutton(frame2, text="tk Radiobutton3", variable=Var3, value=3)
        R3.pack()

        R4 = Radiobutton(frame2, text="ttk Radiobutton1", variable=Var3, value=1)
        R4.pack()
        R5 = Radiobutton(frame2, text="ttk Radiobutton2", variable=Var3, value=2)
        R5.pack()
        R6 = Radiobutton(frame2, text="ttk Radiobutton3", variable=Var3, value=3)
        R6.pack()
